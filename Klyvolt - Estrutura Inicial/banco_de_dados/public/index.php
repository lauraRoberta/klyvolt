...
// Conectar ao banco
try {
    $pdo = new PDO('mysql:host=localhost;dbname=gestao_energetica;charset=utf8', 'root', '');
...
$stmt = $pdo->query("SELECT l.*, m.nome_maquina FROM LEITURA l JOIN MAQUINA m ON l.Id_maquina = m.Id_maquina ORDER BY l.data_leitura DESC LIMIT 10");
