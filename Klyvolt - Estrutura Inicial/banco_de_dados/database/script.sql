-- ============================================================
-- SISTEMA DE GESTÃO ENERGÉTICA - SCRIPT COMPLETO
-- ============================================================

-- Criar banco de dados (se não existir)
CREATE DATABASE IF NOT EXISTS gestao_energetica;
USE gestao_energetica;
...
CREATE TABLE IF NOT EXISTS USUARIO (
    ...
    tipo_usuario ENUM('Admin', 'Operador', 'Visualizador') NOT NULL DEFAULT 'Operador',
...
CREATE TABLE IF NOT EXISTS TARIFA (
    ...
    tipo_tarifa ENUM('Convencional', 'Horossazonal', 'Bandeira') NOT NULL DEFAULT 'Convencional',
    Id_localizacao INT NOT NULL,
    data_criacao DATETIME DEFAULT CURRENT_TIMESTAMP,
    data_alteracao DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (Id_localizacao) REFERENCES LOCALIZACAO(Id_localizacao) ON DELETE CASCADE,
...
-- ============================================================
-- DADOS DE TESTE (PARA VOCÊ COMEÇAR)
-- ============================================================
